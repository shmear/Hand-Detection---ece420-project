...
public class Sample4Mixed extends Activity {
    ...
    private MenuItem            mItemPreviewRun;
    private MenuItem			mItemShowBackground;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mItemPreviewRGBA = menu.add("Binary Preview");
        mItemPreviewRun = menu.add("Run Program");
        mItemShowBackground = menu.add("Show all lines");
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        } else if (item == mItemPreviewRun) {
            mView.setViewMode(Sample4View.VIEW_MODE_RUN);
        } else if (item == mItemShowBackground) {
            mView.setViewMode(Sample4View.VIEW_MODE_BACKGROUND);
        }
        return true;
    }
}
